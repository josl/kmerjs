            ...
            .then(function (kmerMap) {
                ...
                matches.event
                    .on('winner', function (winner) {
                        let seq = winner['template'];
                        let score = winner['score'];
                        let expec = winner['expected'];
                        let z = winner['z'];
                        let p = winner['probability'];
                        let fracQ = winner['frac-q'];
                        let fracD = winner['frac-d'];
                        let cov = winner['depth'];
                        let ulen = winner['kmers-template'];
                        let spec = winner['species'];
